	...
	<div class="gtco-section" style="padding: 1em 0;">
		<div class="gtco-container">
			...
			<div class="col-md-12 new-job-post">
				<form role="form" id="addCompany" action="<?php echo base_url() ?>index.php/backend/jobs/addNewJob" method="post" role="form" enctype="multipart/form-data">
						<div class="box-body">
							<div class="row">
							<div class="col-md-12">
								...
								<div class="row">
									...
									<div class="form-group">
											...
											<div class="col-md-4">
													<img id="previewimage" onclick="$('#uploadFile').click();" src="<?php echo base_url(); ?>assets/images/product_image.gif" style="cursor: pointer;height: 150px;width: 150px;position: relative;z-index: 10;"/>
