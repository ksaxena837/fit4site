            ...
            <div class="col-md-12">
              <!-- general form elements -->
                <div class="box box-primary">
                    ...
                    <form role="form" id="addUser" action="<?php echo base_url() ?>index.php/customGroup/addGroup" method="post" role="form" enctype="multipart/form-data">

                        <div class="box-body">
                          <div class="col-md-12">
                              <div class="form-group">
                                  <label for="product_code">Title</label>
                                    <input class="form-control" type="text" id="title" value="<?php echo set_value('title'); ?>" name="title" placeholder="Group Title" >
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control input-lg" id="description"  name="description" placeholder="Group Description" rows="4" ><?php echo set_value('description'); ?></textarea>
                            ...
                            <div class="col-md-12">
                              <div class="form-group">
                                <label class="col-md-2 control-label">Group As<span class="text-danger">*</span></label>
                                  <div class="radio">
                                    <label>
                                      <input type="radio" name="group_visibility" id="optionsRadios1" value="public" checked="">
                                      Public
                                    </label>
                                    <label>
                                      <input type="radio" name="group_visibility" id="optionsRadios2" value="private">
                                        Private
                                    </label>
                                  </div>
