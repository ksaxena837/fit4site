            ...
            <div class="col-md-12">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" id="addCompany" action="<?php echo base_url() ?>index.php/jobs/editJob" method="post" role="form" enctype="multipart/form-data">
...
/* script */
function initialize() {
   var latlng = new google.maps.LatLng(<?php echo $job[0]->lat;?>,<?php echo $job[0]->lng;?>);
