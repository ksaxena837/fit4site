            ...
            <div class="col-md-12">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" id="addUser" action="<?php echo base_url() ?>index.php/account/add-category" method="post" role="form" enctype="multipart/form-data">
                        <div class="box-body">
                          <div class="col-md-12">
                              <div class="form-group">
                                  <label for="product_category">Product Category</label>
                                    <input class="form-control" type="text" id="product_category" value="<?php echo set_value('product_category'); ?>" name="product_category" placeholder="Product Category" >
