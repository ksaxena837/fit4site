                ...
                <div class="box box-primary">
                  ...
                  <form class="form-horizontal"  method="post" enctype="multipart/form-data">
                      <div class="form-group">
                          ...
                          <div class="col-md-7">
                              <input class="form-control" type="text" id="sub_category_name" value="<?php echo $post->subcategory_name;?>" name="sub_category_name" placeholder="Category Name" >
                                  <div style="margin-top: 0px; color: red;"><?= form_error('sub_category_name'); ?></div>
                          </div>
                      </div>

                      <div class="form-group">
                          <label class="col-md-2 control-label">Category Image<span class="text-danger">*</span></label>
                          <div class="col-md-7">
                              <img id="previewimage" onclick="$('#uploadFile').click();" src="<?php echo base_url(); ?>uploads/subcategory/<?=$post->image?>" style="cursor: pointer;height: 210px;width: 210px;position: relative;z-index: 10;"/>
                              <input type="file" id="uploadFile" name="subimage" style="position: absolute; margin: 0px auto; visibility: hidden;" accept="image/*"  />
                              <input type="hidden"  value="<?php echo  $post->image;?>" name="sub_category_image">
                              <input type="hidden"  value="<?php echo $post->subcat_id;?>" name="insertid">
                          </div>
                      </div>
