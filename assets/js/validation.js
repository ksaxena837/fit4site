...
$(document).ready(function(){
    ...
    jQuery.validator.addMethod("notEqualTo", function(value, element)
       ...
       {
           var response;
           var post_url_check_username = baseurl + "index.php/user/checkUsernameExist/";
       ...
       jQuery.validator.addMethod("checkEmailExist", function(value, element)
       {
           ...
           var post_url_check_email = baseurl +"index.php/user/checkEmailExist/";
       ...
       jQuery.validator.addMethod("checkMobileExist", function(value, element)
       {
           ...
           var post_url_check_mobile = baseurl + "index.php/user/checkMobileExist/";
       ...
       jQuery.validator.addMethod("checkMobileExist2", function(value, element)
       {
           ...
           var post_url_check_mobile2 = baseurl + "index.php/user/checkMobileExist2/";
       ...
       jQuery.validator.addMethod("checkPhoneExist", function(value, element)
       {
           ...
           var post_url_check_phone = baseurl +"index.php/user/checkPhoneExist/";
	   ...
	   jQuery.validator.addMethod('checkMobileExist1Same', function(value, element)
	   {
			...
			var post_url_check_phone = baseurl +"index.php/profile/checkMobileExist1Same/";
		...
		jQuery.validator.addMethod('checkMobileExist2Same', function(value, element)
		{
			...
			var post_url_check_mobile2 = baseurl + "index.php/profile/checkMobileExist2Same/";
		...
		jQuery.validator.addMethod('checkPhoneExistSame', function(value, element)
		{
			...
			var post_url_check_mobile2 = baseurl + "index.php/profile/checkPhoneExistSame/";
  ...
  jQuery.validator.addMethod("checkEmailExistFranchise", function(value, element)
       {
           ...
           var post_url_check_email_franchise = baseurl +"index.php/franchise/franchise/checkEmailExist/";
