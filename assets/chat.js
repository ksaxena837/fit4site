...
function createChatBox(chatboxtitle, minimizeChatBox) {
    ...
    jQuery(" <div />").attr("id", "chatbox_" + chatboxtitle).addClass("chatbox").html('<div class="chatboxhead"><div class="chatboxtitle">' + chatboxtitle + '</div><div class="chatboxoptions"><a href="javascript:void(0)" onclick="javascript:toggleChatBoxGrowth(\'' + chatboxtitle + '\')">-</a> <a href="javascript:void(0)" onclick="javascript:closeChatBox(\'' + chatboxtitle + '\')">X</a></div><br clear="all"/></div><div class="chatboxcontent"></div><div class="chatboxinput"><textarea class="chatboxtextarea" onkeydown="javascript:return checkChatBoxInputKey(event,this,\'' + chatboxtitle + '\');"></textarea></div>').appendTo(jQuery("body"));
...
function chatHeartbeat() {
    ...
    jQuery.ajax({
        url: "http://cash.infiniteloopcorp.com/construction/application/views/chat.php?action=chatheartbeat",
        cache: false,
        dataType: "json",
...
function closeChatBox(chatboxtitle) {
    ...
    restructureChatBoxes();
    jQuery.post("http://cash.infiniteloopcorp.com/construction/application/views/chat.php?action=closechat", {
...
function checkChatBoxInputKey(event, chatboxtextarea, chatboxtitle) {
    if (event.keyCode == 13 && event.shiftKey == 0) {
        ...
        if (message != '') {
            jQuery.post("http://cash.infiniteloopcorp.com/construction/application/views/chat.php?action=sendchat", {
                to: chatboxtitle,
                message: message
            }, function(data) {
...
function startChatSession() {
    ...
    jQuery.ajax({
        url: "http://cash.infiniteloopcorp.com/construction/application/views/chat.php?action=startchatsession",
        cache: false,
        dataType: "json",
        success: function(data) {
          //console.log(data); return false;
